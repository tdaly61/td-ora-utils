...
NEW_PASSWORD="_Welcome12345"  # could get this from env if you want to avoid declaring here
CONTAINER_NAME="adb_container"
WALLET_DIR="$HOME/myadbwallet"
export TNS_ADMIN="$WALLET_DIR"

# change the default and expired ADMIN password 
docker exec $CONTAINER_NAME /u01/scripts/change_expired_password.sh MY_ATP admin Welcome_MY_ATP_1234 $NEW_PASSWORD
